...
function Blog({ handleMobileModal }) {
        ...
        <>
          ...
          <div className="blog__content">
            <div className="blog__content-grid">
              <div className="blog__content-post">
                ...
                <div className="blog__content-post_paragraph">
                  <p className="blog__content-post_paragraph-text">
                    ...
                    property, the land offers many issues that any homeowner
                    will have to face. One of those issues is having to
                    determine what you own based on where your property is
                    located. You’re going to find many things to
                  </p>
                  <Link
                    to="/need-a-survey"
              ...
              <div className="blog__content-post">
                ...
                <div className="blog__content-post_paragraph">
                  <p className="blog__content-post_paragraph-text">
                    ...
                    impossible task. While most people have difficulty driving
                    to work during a dusting of snow, land surveyors are
                    expected to complete jobs that can range from the average
                    home to acres of farmland. So this brings up the question,
                  </p>
                  <Link
                    to="/can-you-order"
                    className="blog__content-post_paragraph-link"
              ...
              <div className="blog__content-post">
                <div className="blog__content-post_image">
                  <Link to="/plat-problems" className="blog__content-post_link">
                    <img
              ...
              <div className="blog__content-post">
                ...
                <div className="blog__content-post_content">
                  <p className="blog__content-post_paragraph-text">
                    Plat problems: Surveyor tells county about problems with
                    subdivision’s layout By Jamie Kelly
                    editor@willistonherald.com May 16, 2018 on Williston Herald
                    A subdivision in Williams County might need to be
                    re-surveyed, and it isn’t clear who will need to bear the
                    cost of that, the Williams County Commission heard Tuesday
                    morning. Blake Sexton, a surveyor, told
                  </p>
                  <Link
                    to="/adverse-possession"
                    className="blog__content-post_paragraph-link"
